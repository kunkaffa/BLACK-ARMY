...
def udp_flood(ip, port, message, duration):
    ...
    while True:
        ...
        try:
            ...
            packet_count += 1
            print(f"\033[103m \033[97mADMIN SAFITRI \0330m   \033[38;5;206mSENT PACKET   \033[104m \033[32m{packet_count}\033[0")
            print(f"\033[mADMIN SAFITRI \0330m   \033[38;5;206mSENT PACKET   \033[33m{packet_count}\033[0")
        except socket.error:
